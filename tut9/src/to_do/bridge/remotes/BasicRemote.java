...
public class BasicRemote implements Remote {
	...
	public void volumeDown() {
		...
		System.out.println("Current volume status: volume down");
	...
	public void volumeUp() {
		...
		System.out.println("Current volume status: volume up");
	...
	public void channelDown() {
		...
		System.out.println("Current channel status: channel down");
	...
	public void channelUp() {
		...
		System.out.println("Current channel status: channel up");
